              ...
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <label class="radio-inline">
                    <input type="radio" name="radio" value="0">Theo Tháng
                  </label>
                  <label class="radio-inline">
                    <input type="radio" name="radio" value="1" checked>Theo Quý
                  </label>
                </div>
              </div>
            </div>
...
<div id="content" style="margin-bottom: 90px;">
  <center><h2><b>Thống Kê Học Viên Theo Quý Năm {{$Nam}}</b></h2></center>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#btnPrint').click(function(){
      ...
      print+="</style>";
      print+= "<h1><center><b>Thống Kê Học Viên Theo Quý 2021</b> </center></h1>";
