  ...
  <div class="row" style="background: white">
    ...
    <div class="col-xs-6 col-md-6 col-md-6 col-lg-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <form action="{{route('thong-ke-theo-khoa')}}" method="post">
            <input type="hidden" name="_token" value="{{csrf_token()}}">
            <div class="col-lg-6" style="padding: 0px 0px;">
              <div class="form-group">
                <label class="col-lg-12 control-label">
                ...
                <div class="col-lg-12" >
                  <select class="form-control" style="width: 100%" name="khoahoc" id='khoahoc' required>
                    <option value=""></option>
...
<div id="content" style="margin-bottom: 90px;">
  <center><h2><b>Thống Kê Học Viên {{$NowYear}}</b></h2></center>
...
<script type="text/javascript">
    $(function () {
      ...
      title: {
        text: 'Biểu Đồ Cột Thành Tích Học Viên '+<?php echo $NowYear ?>
      },
      xAxis: {
      ...
      series: [{
        ...
        Highcharts.chart('bieudotron_tt', {
          ...
          title: {
            text: 'Biểu Đồ Tròn Thành Tích Học Viên '+<?php echo $NowYear ?> 
          },
          tooltip: {
          ...
          Highcharts.chart('bieudoduong_tt', {
            ...
            title: {
              text: 'Biểu Đồ Đường Thành Tích Học Viên '+<?php echo $NowYear ?>
            },
            xAxis: {
              categories: ['Tháng 1', 'Tháng 2', 'Tháng 3', 'Tháng 4', 'Tháng 5', 'Tháng 6',
                    'Tháng 7', 'Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11', 'Tháng 12'],
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#khoahoc').change(function(){
      var ID = $(this).val();
       $.get("thongke/tenlop/"+ID, function(data){
          $('#tenlop').html(data);
