            ...
            <div class="col-lg-12">
                <div>
                    <h5>
                        ...
                        <p>Kết quả: Điểm lý thuyết:&ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->DiemLyThuyet}}</b>&ensp;&ensp;&ensp;&ensp; Điểm thực hành: &ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->DiemThucHanh}}</b>&ensp;&ensp;&ensp;Tổng kết: &ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->TongKet}}</b></p>
                    </h5>
                </div>
            </div>
            <div class="col-lg-12">
