            ...
            <div class="col-lg-12">
                <div>
                    <h5>
                        ...
                        <p>Kết quả: Điểm nghe:&ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->DiemNghe}}</b>&ensp;&ensp;&ensp;&ensp; Điểm đọc: &ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->DiemDoc}}</b>&ensp;&ensp;&ensp;Tổng kết: &ensp;&ensp;&ensp;&ensp;<b>{{$vanbang[0]->TongKet}}</b></p>
                    </h5>
                </div>
            </div>
            <div class="col-lg-12">
